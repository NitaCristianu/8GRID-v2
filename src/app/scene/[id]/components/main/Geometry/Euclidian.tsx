"use client"
import { ePoints_Calc_data, ePoints_data, eSegments_data } from "@/app/scene/[id]/data/elements";
import { CAN_SELECT, GRID_POSITION, HOVERING_GRAPHS, HOVERING_LABELS, MODE, POINT_RADIUS, SEGMENT_WIDTH, SELECTED, SELECT_RECT, VARIABLES, vec2D } from "@/app/scene/[id]/data/globals";
import { AddPoint, Distance_Squared, GetClosestPoint, GetHovering, GetHoveringPoint, IsPointInRect, IsSegmentInRect, ObtainPosition, decomposeSegment, getCoords, getSegmentCoords, isEPointsCalc, toGlobal, toLocal } from '@/app/scene/[id]/data/management';
import { ePoint, ePoints_Calc, eSegment, variable } from "@/app/scene/[id]/data/props";
