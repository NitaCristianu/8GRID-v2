...
import { GRAPHS } from "@/app/scene/data/elements";
import { ACCENT, BACKGROUND, GRID_POSITION, HOVERING_GRAPHS, HOVERING_LABELS, MODE, SECONDARY, SELECTED_GRAPH, VARIABLES, vec2D } from "@/app/scene/data/globals";
import { IsPointInRect, parseRGB, ReplaceLetter, rgb, RGB2string, toGlobal, toLocal, transparent } from "@/app/scene/data/management";
import { Graph } from "@/app/scene/data/props";
