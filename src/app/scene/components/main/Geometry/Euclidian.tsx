"use client"
import { ePoints_Calc_data, ePoints_data, eSegments_data } from "@/app/scene/data/elements";
import { CAN_SELECT, GRID_POSITION, HOVERING_GRAPHS, HOVERING_LABELS, MODE, POINT_RADIUS, SEGMENT_WIDTH, SELECTED, SELECT_RECT, VARIABLES, vec2D } from "@/app/scene/data/globals";
import { AddPoint, Distance_Squared, GetClosestPoint, GetHovering, GetHoveringPoint, IsPointInRect, IsSegmentInRect, ObtainPosition, decomposeSegment, getCoords, getSegmentCoords, isEPointsCalc, toGlobal, toLocal } from '@/app/scene/data/management';
import { ePoint, ePoints_Calc, eSegment, variable } from "@/app/scene/data/props";
import { usePrevious } from "@/app/scene/hooks/usePrevious";
import useResize from "@/app/scene/hooks/useResize";
