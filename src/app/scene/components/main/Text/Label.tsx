"use client"
import { labels_data } from '@/app/scene/data/elements';
import { ACCENT, BACKGROUND, GRID_POSITION, HOVERING_LABELS, MODE, SECONDARY, SELECTED, SELECT_RECT, VARIABLES, vec2D } from '@/app/scene/data/globals';
import { motion, useScroll } from 'framer-motion';
import { useAtom } from 'jotai';
import React, { FormEvent, RefObject, createRef, useCallback, useEffect, useRef, useState } from 'react';
import style from "./styles.module.css";
import { createFragmentList, transparent } from '@/app/scene/data/management';
import { usePrevious } from '@/app/scene/hooks/usePrevious';
import ReactTextareaAutosize from 'react-textarea-autosize';
import 'froala-editor/css/froala_style.min.css';
import { Fragment, Tag, variable } from '@/app/scene/data/props';
