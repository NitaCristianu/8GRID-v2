...
import { ACCENT, GRID_POSITION, MODE, POINT_RADIUS, SELECTED, VARIABLES, blocks } from "@/app/editor/data/globals";
import { useEffect, useRef, useState } from "react";
import useResize from "@/app/editor/hooks/useResize";
import { AddPoint, Distance_Squared, DoesSegmentExist, GetAnyHoveringPoint, GetHoveringPoint, ObtainPosition, getCoords, getUniqueTag, toGlobal, toLocal, transparent } from "@/app/editor/data/management";
import { ePoints_Calc_data, ePoints_data, eSegments_data, GRAPHS, labels_data } from "@/app/editor/data/elements";
import { v4 } from "uuid";
import { segment_render_mode, tips } from "@/app/editor/data/props";
