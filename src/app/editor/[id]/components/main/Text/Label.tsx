"use client"
import { labels_data } from '@/app/editor/[id]/data/elements';
import { ACCENT, BACKGROUND, GRID_POSITION, HOVERING_LABELS, MODE, SECONDARY, SELECTED, SELECT_RECT, VARIABLES, vec2D } from '@/app/editor/[id]/data/globals';
import { motion, useScroll } from 'framer-motion';
import { useAtom } from 'jotai';
import React, { FormEvent, RefObject, createRef, useCallback, useEffect, useRef, useState } from 'react';
import style from "./styles.module.css";
import { createFragmentList, transparent } from '@/app/editor/[id]/data/management';
import { usePrevious } from '@/app/editor/[id]/hooks/usePrevious';
import ReactTextareaAutosize from 'react-textarea-autosize';
import { Fragment, Tag, variable } from '@/app/editor/[id]/data/props';
