...
import { GRAPHS } from "@/app/editor/[id]/data/elements";
import { ACCENT, BACKGROUND, GRID_POSITION, HOVERING_GRAPHS, HOVERING_LABELS, MODE, SECONDARY, SELECTED_GRAPH, VARIABLES, vec2D } from "@/app/editor/[id]/data/globals";
import { IsPointInRect, parseRGB, ReplaceLetter, rgb, RGB2string, toGlobal, toLocal, transparent } from "@/app/editor/[id]/data/management";
import { Graph } from "@/app/editor/[id]/data/props";
