...
import { ACCENT, GRID_POSITION, MODE, POINT_RADIUS, SELECTED, VARIABLES, blocks } from "@/app/data/globals";
import { useEffect, useRef, useState } from "react";
import useResize from "@/app/hooks/useResize";
import { AddPoint, Distance_Squared, DoesSegmentExist, GetAnyHoveringPoint, GetHoveringPoint, ObtainPosition, getCoords, getUniqueTag, toGlobal, toLocal, transparent } from "@/app/data/management";
import { ePoints_Calc_data, ePoints_data, eSegments_data, GRAPHS, labels_data } from "@/app/data/elements";
import { v4 } from "uuid";
