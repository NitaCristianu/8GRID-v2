...
import { ObtainPosition, decomposeSegment, findNonSurroundedLetters, getCoords, getSegmentCoords, getUniqueLetters, rgbToHex, transparent } from "@/app/data/management";
